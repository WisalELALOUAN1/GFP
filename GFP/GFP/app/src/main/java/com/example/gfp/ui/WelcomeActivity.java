...
public class WelcomeActivity extends AppCompatActivity {
    ...
    @Inject
    SessionManager session;              // ← Hilt injecte SessionManager
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 3) Charger l'utilisateur spécifique
        ...
        // 4) Continuer vers CategoryOptionsActivity
    ...
    protected void onDestroy() {
        super.onDestroy();
        // 5) Fermer Realm pour éviter les fuites
